...
class ExecutionEntity(Base):
    ...
    def delete(self, session: Session):
        """
        Delete an existing entity from the database based on the identifier.
        ...
        if existing_entity:
            ...
            LOGGER.warning(f"The entity {self.identifier} doesn't exist in the records of the database. Unable to delete!")
        session.commit()
